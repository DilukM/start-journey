...
We don't care if you break anything. This is a playground, and we promote frequent failure. Enjoy participating in projects you make with your other classmates and use this as a practice area. By participating in these initiatives, many students have obtained practical experience "working in teams."

## A Guide to Get Started (used to be the 4 step guide)

1. On the [GitHub page for this repository](https://github.com/TECH-STRIKE/start-journey), click on the button "Fork."
...
4. Before you make any changes, [keep your fork in sync](https://www.freecodecamp.org/news/how-to-sync-your-fork-with-the-original-git-repository/) to avoid merge conflicts:
   ...
   ```bash
   git remote add upstream https://github.com/TECH-STRIKE/start-here-guidelines.git
...
10. Wait until the maintainers merges your pull request. If there are any conflicts, you will get a notification.
...
12. To see the TECH-STRIKE Icon in your GitHub profile, [follow these steps](https://help.github.com/articles/publicizing-or-hiding-organization-membership/) (you must complete steps 1 and 2 for this to work).
